                                ...
                                <div class="col-12 grid-12">
                                    ...
                                    <div class="col-9 sm:col-12">
                                        <div class="grid-12">
                                            ...
                                            <entity-field :entity="entity" classes="col-12" label="<?php i::_e('Tipo do espaço'); ?>" prop="type" @change="(()=>{ const typeId = entity.type?.id ?? Number(entity.type); if (typeId !== spaceOtherTypeId) entity.informarQualOutroTipoDeEspaco = ''; })()"></entity-field>
