...
<mc-card class="registration-workplan" v-if="registration.opportunity.enableWorkplan && enableWorkplanInStep">
    <template #title>
        ...
        <br>
        <!-- Botão para reativar tutorial (sistema localStorage) -->
        ...
        <div id="container_goals">
            <div v-for="(goal, index) in workplan.goals" :key="index" class="registration-workplan__goals">
                <div class="registration-workplan__header-goals">
                    ...
                    <div id="registration-workplan__delete-goal" class="registration-workplan__goal-actions">
                    ...
                    <div id="container_deliveries">
                        <div v-for="(delivery, index_) in goal.deliveries" :key="delivery.id != null && delivery.id !== '' ? delivery.id : 'delivery-' + index_" class="registration-workplan__goals__deliveries">
                            <div class="registration-workplan__header-deliveries">
                                ...
                                <div id="registration-workplan__delete-delivery" class="registration-workplan__delivery-actions">
