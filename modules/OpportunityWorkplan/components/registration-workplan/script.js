app.component('registration-workplan', {
    ...
    methods: {
                    ...
                    if (typeof delivery.teamCompositionGender === 'string') {
                        try {
                            ...
                            delivery.teamCompositionGender = {
                                cisgenderWoman: 0, cisgenderMan: 0, transgenderWoman: 0,
                                transgenderMan: 0, nonBinary: 0, otherGenderIdentity: 0, preferNotToSay: 0
                            };
                        }
                    }
                    ...
                    if (typeof delivery.teamCompositionRace === 'string') {
                        try {
                            ...
                            delivery.teamCompositionRace = {
                                white: 0, black: 0, brown: 0, indigenous: 0, asian: 0, notDeclared: 0
                            };
                        }
                    }
        ...
        // ── Totais de composição da equipe ────────────────────────────────────
        calculateGenderTotal(composition) {
            if (!composition) return 0;
            return (Number(composition.cisgenderWoman) || 0) +
        ...
        calculateRaceTotal(composition) {
            if (!composition) return 0;
            return (Number(composition.white) || 0) +
        ...
        // ── Tutorial (sistema localStorage do container) ──────────────────────
        ...
        startTutorialWorkplan() {
            ...
            this.tour.addStep({
                ...
                attachTo: { element: '#registration-workplan', on: 'bottom' },
            ...
            this.tour.addStep({
                ...
                attachTo: { element: '#projectDuration', on: 'bottom' },
            ...
            this.tour.addStep({
                ...
                attachTo: { element: '#culturalArtisticSegment', on: 'bottom' },
                buttons: this.tutorialButtonsDefault()
            });
        ...
        startTutorialGoal() {
            ...
            this.tour.addStep({
                ...
                attachTo: { element: '#container_goals', on: 'bottom' },
                buttons: this.tutorialButtonsDisabled()
            });
            ...
            this.tour.addStep({
                ...
                attachTo: { element: '#registration-workplan__delete-goal', on: 'bottom' },
                buttons: this.tutorialButtonsDefault()
            });
            ...
            this.tour.addStep({
                ...
                attachTo: { element: '#button-registration-workplan__new-delivery', on: 'bottom' },
                buttons: this.tutorialButtonsDefault()
            });
            ...
            this.tour.addStep({
                ...
                attachTo: { element: '#button-registration-workplan__save-goal', on: 'bottom' },
                buttons: this.tutorialButtonsDefault()
            });
        ...
        startTutorialDelivery() {
            ...
            this.tour.addStep({
                ...
                attachTo: { element: '#container_deliveries', on: 'bottom' },
                buttons: this.tutorialButtonsDisabled()
            });
            ...
            this.tour.addStep({
                ...
                attachTo: { element: '#registration-workplan__delete-delivery', on: 'bottom' },
                buttons: this.tutorialButtonsDefault()
            });
